...
export const ModalComponent = {
  ...
  createStatesSelect: function() {
    ...
    let selectStatesElement =
      '<select id="state" name="State" class="states form-control">';
  ...
  submit: function submit(event) {
    ...
    this.el
      ...
      .removeEventListener("submit", this);
  },
  fetchFormValues: function() {
    ...
    valuesMap["layoutVariation"] = sessionStorage.getItem(
      "variationIdentifier"
    );
